...
if __name__ == "__main__":
    keywords = ['ポッチャマ','ポッチャマ ぬいぐるみ', 'ポッチャマ アニメ', 'ポッチャマ フィギュア', 'ポッチャマ ゲーム', 'ポッチャマ イラスト']
    target_dir = r"C:\Users\harap\OneDrive - Kanazawa University\デスクトップ\pokemon\pokemon_dataset\img_All\393_Piplup"
